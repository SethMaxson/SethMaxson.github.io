...
export const characterIdleRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 0 }, length: 8 };
export const characterIdleLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 1 }, length: 8 };
export const characterWalkingRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 2 }, length: 4 };
export const characterWalkingLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 3 }, length: 4 };
export const characterWhipRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 4 }, length: 3 };
export const characterWhipLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 5 }, length: 3 };
export const characterDamageRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 6 }, length: 1 };
export const characterDamageLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 7 }, length: 1 };
export const characterJumpRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 8 }, length: 1 };
export const characterJumpLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 9 }, length: 1 };
export const characterFallRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 10 }, length: 2 };
export const characterFallLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 11 }, length: 1 };
export const characterDeadRight: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 12 }, length: 1 };
export const characterDeadLeft: Sprite = { image: playerSheet, frameSize: playerFrameSize, animationOffset: { x: 0, y: 13 }, length: 1 };
//#endregion
...
export const npcImgs = {
	left: { image: npcImg, frameSize: { x: 20, y: 40 }, animationOffset: { x: 0, y: 0 }, length: 8 } as Sprite,
	right: { image: npcImg, frameSize: { x: 20, y: 40 }, animationOffset: { x: 0, y: 1 }, length: 8 } as Sprite,
	alert: { image: alertImg, frameSize: { x: 32, y: 32 }, animationOffset: { x: 0, y: 0 }, length: 1 } as Sprite,
};
//#endregion
...
export const smbSheet = {
	ground: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 0, y: 0 }, length: 1 } as Sprite,
	brick: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 1, y: 0 }, length: 1 } as Sprite,
	pipeTopLeft: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 2, y: 0 }, length: 1 } as Sprite,
	pipeTopRight: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 3, y: 0 }, length: 1 } as Sprite,
	questionBlock: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 0, y: 1 }, length: 1 } as Sprite,
	hardBlock: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 1, y: 1 }, length: 1 } as Sprite,
	pipeLeft: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 2, y: 1 }, length: 1 } as Sprite,
	pipeRight: { image: smbSheetImg, frameSize: smbFrameSize, animationOffset: { x: 3, y: 1 }, length: 1 } as Sprite
}

const goombaImg = new Image();
goombaImg.src = "./src/sprites/enemy/goomba.png";
export const goombaImgs = { image: goombaImg, frameSize: { x: 16, y: 16 }, animationOffset: { x: 0, y: 0 }, length: 2 } as Sprite;
//#endregion
...
export const enemyDeath: Sprite = { image: enemyDeathImg, frameSize: { x: 110, y: 130 }, animationOffset: { x: 0, y: 0 }, length: 5 };
...
export interface Sprite
{
	...
	frameSize: IPoint2D;
	// The position of the first frame of this animation (coordinates in frames, not pixels)

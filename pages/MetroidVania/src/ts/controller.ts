...
export const bindKeyHandlers = () =>
{
	window.onkeydown = (e: KeyboardEvent) =>
	{
		...
		if (e.key === "j") userController.sprint = true;
		if (e.key === ";") userController.interact = true;
		if (e.key === "Escape") userController.pause = true;
	};
	...
	window.onkeyup = (e: KeyboardEvent) =>
	{
		...
		if (e.key === "j") userController.sprint = false;
		if (e.key === ";") userController.interact = false;
		if (e.key === "Escape") userController.pause = false;
	};
};

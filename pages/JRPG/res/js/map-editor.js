...
$(document).ready(function () {
    ...
    $("#map-scroller").on('wheel', function (event) {
        if (event.ctrlKey == true || event.altKey == true) {
            ...
            let deltaY = e.deltaY !== undefined ? e.deltaY : (event.originalEvent ? event.originalEvent.deltaY : 0);
    ...
    $("#button-create").click(function () {
        let newMapName = $("#new-map-name").val();
        let newMapSize = { x: $("#input-size-x").val(), y: $("#input-size-y").val() };
...
function calcOffset() {
    ...
    var offsetx = $("#map-scroller").scrollLeft() / Settings.Scale;
    var offsety = $("#map-scroller").scrollTop() / Settings.Scale;
...
export var MapEditTools;
(function (MapEditTools) {
    MapEditTools[MapEditTools["None"] = 0] = "None";
    MapEditTools[MapEditTools["Paint"] = 1] = "Paint";
    MapEditTools[MapEditTools["Eraser"] = 2] = "Eraser";
})(MapEditTools || (MapEditTools = {}));
export var MapEditModes;
(function (MapEditModes) {
    MapEditModes[MapEditModes["None"] = 0] = "None";
    MapEditModes[MapEditModes["EditBackground"] = 1] = "EditBackground";
    MapEditModes[MapEditModes["EditForeground"] = 2] = "EditForeground";
    MapEditModes[MapEditModes["EditCollision"] = 3] = "EditCollision";
})(MapEditModes || (MapEditModes = {}));

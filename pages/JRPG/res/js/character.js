import { Settings, div, Enums } from "./utility.js";
...
export class Character {
    constructor(name, x, y, dir, moveType, message, sprite = "soldier") {
        this.name = name;
        this.animcycle = 12;
        this.hidden = false;
    ...
    draw(ctx, offset) {
        if (!this.hidden) {
            ...
            ctx.drawImage(this.image, frameNo, vOff, this.frameSize.x, this.frameSize.y, positionX, positionY, this.renderSize.x * Settings.GS, this.renderSize.y * Settings.GS);
        }
    }

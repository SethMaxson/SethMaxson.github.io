...
export function createMapXML(map: LevelMap)
{
...
function createTileNode(xmlDoc: Document, x: number, y: number)
{
...
function createMapNode(xmlDoc: Document, map: LevelMap)
{
	let dataSize = 2;
...
function createEventNode(xmlDoc: Document, map: LevelMap)
{
...
function createDoorsNode(xmlDoc: Document, map: LevelMap)
{
...
function createDoorNode(xmlDoc: Document, door: DoorNode)
{
...
function createNodeWithTextValue(xmlDoc: Document, nodeName: string, value: string)
{
...
function createCharacterNode(xmlDoc: Document, char: Character)
{
...
function saveMapXML(xmltext: string, filename: string)
{
...
function forceDataSize(data: number, dataSize: number): string
{

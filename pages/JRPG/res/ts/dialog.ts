		...
		},
		{
			...
			dialog: [
				...
				] },
				{
					...
					answers: [
						{
							m: "F", next: "main_menu", function: function (ent: Character)
							{
								// ent.Model.gender = "f";
							}
						},
						{
							m: "M", next: "main_menu", function: function (ent: Character)
							{
								// ent.Model.gender = "m";
							}
						},
				...
				},
				{
					...
					answers: [
						{
							m: "Mohawk", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setHair("Warhawk", ent.Model.userData.hairColor || 0x000000);
							}
						},
						{
							m: "Loose_Pony", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setHair("Loose_Pony", ent.Model.userData.hairColor || 0x000000);
							}
						},
						{
							m: "Floppy", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setHair("Floppy", ent.Model.userData.hairColor || 0x000000);
							}
						},
						{
							m: "Pixie", next: "main_menu", function: function (ent: Character)
							{
				...
				},
				{
					...
					answers: [
						{
							m: "HalfOrc", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setRace("halforc");
							}
						},
						{
							m: "Human", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setRace("human");
							}
						},
						{
							m: "Halfling", next: "main_menu", function: function (ent: Character)
							{
								// ent?.Model.setRace("halfling");
							}
						},
						{
							m: "Drow", next: "main_menu", function: function (ent: Character)
							{
			...
			dialog: [
				...
				},
				{
					...
					answers: [
						...
						{
							m: "Braid", next: "main_menu", function: function (ent: Character)
							{

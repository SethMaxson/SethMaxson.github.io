...
function createBeacon(x: number, y: number, z: number){
	beacon = new Beacon();
...
function createIsland(x: number, y: number, z: number){
...
function createSeaGull(x: number, y: number, z: number, s: number){
	seaGull = new SeaGull();

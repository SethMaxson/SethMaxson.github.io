const KILLINGGAMECHARACTERS: IKillingGameCharacter[] = [
	//#region Non-Player Characters
	{
		...
		description: "Diggory comes from a wealthy family in the city of Akorsfield, and is famous in the surrounding area for his parties. He seems is playful and impatient.",
		status: "Alive",
		dislikes: [
			"dirt",
	...
	},
	{
		...
		personalityTags: [],
		profession: "monk",
		description: "Eliot comes from a massive trading port located on an island. He comes across as obnoxious and curious.",
		status: "Alive",
		dislikes: [
			"bright light",
	...
	},
	{
		...
		personalityTags: [],
		profession: "artist",
		description: "Aym is completely mute and comes from the forests of the Verdant Isle. She is unpredictable and stubborn.",
		status: "Alive",
		dislikes: [
			"bullying",
			"low-brow things",
	...
	},
	{
		...
		description: "Chenna is afraid of crossbows and comes from a broken home. She is risk-taking and agreeable, and has found work as an innkeeper.",
		status: "Alive",
		dislikes: [
			"bitter flavors",
			"grumpy people",
	...
	},
	{
		...
		description: "Nora wants to open her own bar and comes from a place only she can pronounce. She is emotional and affectionate.",
		status: "Alive",
		dislikes: [
			"mirrors",
			"fire"
	...
	},
	{
		...
		description: "Nueleth is a quiet, bookish person who comes from a peaceful coastal town. She is restless and careless.",
		status: "Alive",
		dislikes: [
			"loud noises",
			"large gatherings",
	...
	//#endregion Non-Player Characters
	//#region Player Characters
	{
		id: "aaa_gregory",
		name: "Gregory",
		title: "Ultimate Archeologist",
		image: "/dnd/img/characters/npc/killinggame/default-portrait.jpeg",
		race: "Half-Orc",
		subrace: "",
		gender: "Male",
		age: -1,
	...
	},
	{
		id: "aaa_carrie",
		name: "Carrie",
		title: "Ultimate Competitive Eater",
		image: "/dnd/img/characters/npc/killinggame/carrie-portrait.png",
		race: "Halfling",
		subrace: "",
		gender: "Female",
		age: -1,
	...
	},
	{
		...
		intelligence: "average",
		personalityTags: [],
		profession: "college of swords bard",
		description: "A player character",
		status: "Alive",
		dislikes: [],
		likes: [],

		...
		return (
			<div className="bg-dark h-100 w-100 overflow-auto">
				<ul className="list-group list-group-flush">
					{this.props.gifts.sort((a, b) => a.name > b.name && 1 || -1).map((gift, index: number) =>
						<li className="list-group-item list-group-item-dark bg-dark text-light border-secondary border-end-0 border-start-0 position-relative pe-5">
							{/* {gift.id}. */}
							<u><b>{gift.name}</b></u> - {gift.description}
							<span className="position-absolute top-50 end-0 translate-middle-y me-1 pe-1"><i><b>{gift.cost}cp</b></i></span>
						</li>
					)}
				</ul>
			</div>

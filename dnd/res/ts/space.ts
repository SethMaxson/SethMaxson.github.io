...
export module SPACE
{
	...
	{
		constructor(name: string, texture: string, diameter: number = 1)
		{
	...
	{
		constructor(innerRadius?: number, outerRadius?: number, lookAt: THREE.Vector3 = new THREE.Vector3(0.5, -4, 1))
		{
			super(
				new _RingGeometry(innerRadius, outerRadius, 32),

...
function getNameFromGender(gender: string, genderNeutralNames: string[], maleNames: string[], femaleNames: string[]): string
{
	...
	if (gender == "male")
	{
		nameOptions.concat(maleNames);

	} else
	{
		nameOptions.concat(femaleNames);
	}

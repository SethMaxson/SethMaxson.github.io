...
class KillingGameViewerNav extends React.Component {
    render() {
        return (React.createElement("div", { className: "container killing-game-nav h-100" },
            React.createElement("ul", { className: "nav nav-tabs sticky-top fixed-top bg-dark", role: "tablist" },
                React.createElement("li", { className: "nav-item", role: "presentation" },
                    React.createElement("button", { className: "nav-link active", id: "characters-tab", "data-bs-toggle": "tab", "data-bs-target": "#characters", type: "button", role: "tab", "aria-controls": "characters", "aria-selected": "true" }, "Contestants")),
                React.createElement("li", { className: "nav-item", role: "presentation" },
            ...
            React.createElement("div", { className: "tab-content row h-100" },
                React.createElement("div", { className: "tab-pane active h-100", id: "characters", role: "tabpanel", "aria-labelledby": "characters-tab" },
                    React.createElement("div", { className: "list-group h-100 overflow-auto" }, this.props.data.characters.map((character, index) => React.createElement(CharacterLink, { character: character, key: index, onClick: this.props.displayCharacter })))),
                React.createElement("div", { className: "tab-pane h-100", id: "map", role: "tabpanel", "aria-labelledby": "map-tab" },
                    React.createElement(LayeredMap, { layers: this.props.data.mapLayers, displayStack: false })),
                React.createElement("div", { className: "tab-pane h-100", id: "rules", role: "tabpanel", "aria-labelledby": "rules-tab" },
                    React.createElement("div", { className: "bg-light h-100 overflow-auto" },
                        React.createElement("ol", { className: "list-group list-group-numbered" },
                            React.createElement("li", { className: "list-group-item" }, "All characters will live within the area they are trapped in. There is no limit as to the length of their stay."),
                            React.createElement("li", { className: "list-group-item" }, "\"Nighttime\" is from 10 pm to 7 am. Some areas are off-limits at night, so please exercise caution."),
                            React.createElement("li", { className: "list-group-item" }, "Sleeping anywhere other than the dormitory will be seen as sleeping in class and punished accordingly."),
                            React.createElement("li", { className: "list-group-item" }, "With minimal restrictions, you are free to explore Ascendant Aspirations Academy at your discretion."),
                            React.createElement("li", { className: "list-group-item" }, "Violence against the headmaster is strictly prohibited, as is destruction of floating orbs."),
                            React.createElement("li", { className: "list-group-item" }, "An anointed who kills another character will graduate, but only if they can convince the other characters that they are not the anointed. If the anointed succeeds, the anointed can leave, and all other living characters will be killed in the anointed's place. If the anointed is proven guilty, the anointed alone will be rightfully executed."),
                            React.createElement("li", { className: "list-group-item" }, "After three or more people discover a dead body, a \u201Cbody discovery announcement\u201D shall be made to inform everyone of the death."),
                            React.createElement("li", { className: "list-group-item" }, "Additional regulations may be added if necessary.")))))));
    }
}
            ...
            React.createElement("div", { className: "h-100 w-100 d-flex flex-column align-items-stretch overflow-hidden" },
                ...
                React.createElement("div", { className: "row bg-dark flex-grow-1 m-0 overflow-auto" },
                    React.createElement("div", { className: "col-sm-2" },
                        React.createElement("nav", { id: "navbar-example3", className: "navbar navbar-light bg-light flex-column align-items-stretch p-2 m-2 rounded" },
                            React.createElement("a", { className: "navbar-brand", href: "#" }, "Navbar"),
                            React.createElement("nav", { className: "nav nav-pills flex-column" },
                                React.createElement("a", { className: "nav-link", href: "#item-1" }, "Summary"),
                                React.createElement("nav", { className: "nav nav-pills flex-column" },
                                    React.createElement("a", { className: "nav-link ms-3 my-1", href: "#item-1-1" }, "Description"),
                                    React.createElement("a", { className: "nav-link ms-3 my-1", href: "#item-1-2" }, "Item 1-2")),
                                React.createElement("a", { className: "nav-link", href: "#item-2" }, "Item 2"),
                                React.createElement("a", { className: "nav-link", href: "#item-3" }, "Item 3"),
                                React.createElement("nav", { className: "nav nav-pills flex-column" },
                                    React.createElement("a", { className: "nav-link ms-3 my-1", href: "#item-3-1" }, "Item 3-1"),
                                    React.createElement("a", { className: "nav-link ms-3 my-1", href: "#item-3-2" }, "Item 3-2"))))),
                    React.createElement("div", { className: "col-auto overflow-auto bg-white" },
                        React.createElement("div", { className: "bg-white flex-column", "data-bs-spy": "scroll", "data-bs-target": "#navbar-example3", "data-bs-offset": "0" },
                            ...
                            React.createElement("p", null, "..."),
                            React.createElement("h4", { id: "item-3" }, "Item 3"),
                            React.createElement("p", null, "..."),
                            React.createElement("h5", { id: "item-3-1" }, "Item 3-1"),
                            React.createElement("p", null, "..."),
                            React.createElement("h5", { id: "item-3-2" }, "Item 3-2"),
                            React.createElement("p", null, "...")))))));
    }
}
class CharacterLink extends React.Component {
    render() {
        ...
        return (React.createElement("button", { className: "list-group-item list-group-item-action", onClick: (ev) => this.props.onClick(this.props.character) },
            this.props.character.name,

        ...
        return (React.createElement("div", { className: "container" },
            ...
            React.createElement("div", { className: "tab-content container", id: "myTabContent" },
                React.createElement("div", { className: "tab-pane row show active", id: "campaign-1", role: "tabpanel", "aria-labelledby": "campaign-1-tab" },
                    React.createElement("div", { className: "accordion", id: "campaign-1-accordion" },
                ...
                React.createElement("div", { className: "tab-pane row", id: "campaign-1-revised", role: "tabpanel", "aria-labelledby": "campaign-1-revised-tab" },
                    ...
                    React.createElement("div", { className: "accordion", id: "campaign-1-revised-accordion" },
                        React.createElement("div", { className: "accordion-item" },
                            React.createElement("h2", { className: "accordion-header", id: "campaign-1-revised-session-1-heading" },
                                React.createElement("button", { className: "accordion-button", type: "button", "data-bs-toggle": "collapse", "data-bs-target": "#campaign-1-revised-session-1", "aria-expanded": "false", "aria-controls": "campaign-1-revised-session-1" },
                                    React.createElement("span", { className: "col-sm-1" }, "12/31/2021"),
                                    React.createElement("span", { className: "col-sm-1" }, "-"),
                                    "A New Hope")),
                            React.createElement("div", { id: "campaign-1-revised-session-1", className: "accordion-collapse collapse", "aria-labelledby": "campaign-1-revised-session-1-heading", "data-bs-parent": "#campaign-1-revised-accordion" },
                                React.createElement("div", { className: "accordion-body" },
                                    ...
                                    React.createElement("p", null, "Sometimes things happen. When things happen, they are recorded here for future reference. It would be best if they were recorded thoroughly and verbosely.")))),
                        React.createElement(SessionEntry, { campaignID: "campaign-1-revised", date: "12/31/2021", title: "Empire Strikes Back", sessionNumber: 2, paragraphs: [
                ...
                React.createElement("div", { className: "tab-pane row", id: "campaign-2", role: "tabpanel", "aria-labelledby": "campaign-2-tab" },
                    React.createElement("div", { className: "accordion", id: "campaign-2-accordion" },
                        React.createElement(SessionNotesCategoryHeader, { text: "Geoss Campaign II" }),
                        React.createElement("div", { className: "accordion-item" },
                            React.createElement("h2", { className: "accordion-header", id: "campaign-2-session-1-heading" },
                                React.createElement("button", { className: "accordion-button", type: "button", "data-bs-toggle": "collapse", "data-bs-target": "#campaign-2-session-1", "aria-expanded": "false", "aria-controls": "campaign-2-session-1" },
                                    React.createElement("span", { className: "col-sm-1" }, "12/31/2021"),
                                    React.createElement("span", { className: "col-sm-1" }, "-"),
                                    "A New Hope")),
                            React.createElement("div", { id: "campaign-2-session-1", className: "accordion-collapse collapse", "aria-labelledby": "campaign-2-session-1-heading", "data-bs-parent": "#campaign-2-accordion" },
                                React.createElement("div", { className: "accordion-body" },
                                    React.createElement("ul", { className: "party-list" },
                                        React.createElement("li", null, "New Hero #1"),
                                        React.createElement("li", null, "New Hero #2"),
                                        React.createElement("li", null, "New Hero #3"),
                                        React.createElement("li", null, "New Hero #4"),
                                        React.createElement("li", null, "New Hero #5")),
                                    React.createElement("p", null, "Sometimes things happen. When things happen, they are recorded here for future reference. It would be best if they were recorded thoroughly and verbosely.")))))))));
    }
}
    ...
    render() {
        ...
        return (React.createElement("div", { className: "accordion-item" },
            React.createElement("h2", { className: "accordion-header", id: id + "-heading" },
                React.createElement("button", { className: "accordion-button", type: "button", "data-bs-toggle": "collapse", "data-bs-target": "#" + id, "aria-expanded": "false", "aria-controls": id },
                    React.createElement("span", { className: "col-sm-1" }, this.props.date),
                    React.createElement("span", { className: "col-sm-1" }, "-"),
                    React.createElement("span", null, this.props.title))),
            React.createElement("div", { id: id, className: "accordion-collapse collapse", "aria-labelledby": id + "-heading", "data-bs-parent": "#" + campaignID + "-accordion" },
                React.createElement("div", { className: "accordion-body" },
                    React.createElement(SessionPartyList, null, "- New Hero #1 - New Hero #2 - New Hero #3 - New Hero #4 - New Hero #5"),
                    this.props.paragraphs.map(value => React.createElement(ParagraphFromRawHTML, { text: value }))))));
    }
}
class SessionPartyList extends React.Component {
    render() {
        return (React.createElement("ul", { className: "party-list" }, this.props.children.split(/-\s/).map(value => (value.trim().length > 0) &&

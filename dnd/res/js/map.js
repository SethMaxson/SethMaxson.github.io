...
var dragging = false;
var dragStartX, dragStartY, dragStopX, dragStopY;
var shiftkey = false;
var ctrlkey = false;
const keys = {
    ctrl: false,
...
function Pedestrian(left = "50%", top = "50%", name = "Party", image = "/dnd/img/maps/icons/jasper.png") {
    //@ts-ignore
...
function PedestrianNPC(left = "50%", top = "50%", name = "Party", image = "/dnd/img/maps/icons/jasper.png") {
    //@ts-ignore
    if (name.constructor !== Array)
        name = [name];
    //@ts-ignore
...
function PartyBattle(left = "50%", top = "50%", name = "Party Member", image = "/dnd/img/maps/icons/jasper.png", target = "#map-container") {
    //@ts-ignore
    if (image.constructor !== Array)
        image = [image];
    var output;
...
function FlyingThing(left = "50%", top = "50%", name = "Party", image = "/dnd/img/maps/icons/jasper.png") {
    //@ts-ignore
    if (name.constructor !== Array)
        name = [name];
    //@ts-ignore

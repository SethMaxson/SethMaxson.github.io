...
class GiftMachine extends React.Component {
    render() {
        return (React.createElement("div", { className: "bg-dark h-100 w-100 overflow-auto" },
            React.createElement("ul", { className: "list-group list-group-flush" }, this.props.gifts.map((gift, index) => React.createElement("li", { className: "list-group-item list-group-item-dark bg-dark text-light border-secondary border-end-0 border-start-0" },
                gift.id,
                ". ",
                gift.name,
                " - ",

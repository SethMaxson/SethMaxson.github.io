...
class LayeredMap extends React.Component {
    ...
    render() {
        return (React.createElement("div", { className: "h-100 w-100 outer-container d-flex flex-column" },
            ...
            React.createElement("div", { className: "layer-container row flex-grow-1 h-100 w-100 m-0" }, this.props.layers.map((image, index) => (this.state.currentLayer == index || this.props.displayStack) && React.createElement(LayeredMapLayer, { imageUrl: image, key: index })))));
    }
    changeLayer(event) {

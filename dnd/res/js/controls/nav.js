                ...
                React.createElement("div", { className: "navbar-nav me-auto" },
                    ...
                    React.createElement("div", { className: "nav-item dropdown" },
                        ...
                        React.createElement("div", { className: "dropdown-menu dropdown-menu-dark", "aria-labelledby": "navbarWorldDropdown" },
                            ...
                            React.createElement("a", { className: "dropdown-item", href: "/dnd/pages/maps/", target: "mainFrame" }, "Maps"),
                    ...
                    React.createElement("div", { className: "nav-item dropdown" },
                        ...
                        React.createElement("div", { className: "dropdown-menu dropdown-menu-dark", "aria-labelledby": "navbarToolDropdown" },
                            ...
                            React.createElement("div", { className: "dropdown-divider" }),
                            React.createElement("a", { className: "dropdown-item", href: "/dnd/pages/adventures/", target: "mainFrame" }, "Adventures"),
                            React.createElement("a", { className: "dropdown-item", href: "/dnd/pages/tools/generators/", target: "mainFrame" }, "Random Generators"),
                            ...
                            React.createElement("a", { className: "dropdown-item", href: "/dnd/pages/tools/table-campaign-1.html", target: "mainFrame" }, "Table")))),

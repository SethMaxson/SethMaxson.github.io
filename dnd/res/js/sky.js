...
export class Sun {
    constructor(radius) {
        this.mesh = new Mesh(new SphereBufferGeometry(radius, 16, 8), new MeshBasicMaterial({ color: 0xfffff6, side: FrontSide }));
        this.mesh.add(new Mesh(new SphereBufferGeometry(radius * 1.2, 16, 8), new MeshBasicMaterial({ color: 0xf3c900, side: BackSide, transparent: true, opacity: 0.4 })));
        //#region set light

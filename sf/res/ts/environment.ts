function getSky(camera: THREE.PerspectiveCamera) {
	var depth = 1500;
	if (camera !== undefined) {
...
function getSun(color: number, intensity: number): THREE.DirectionalLight {
...
class Moon extends THREE.Mesh
{
	...
	constructor(color: number = 0x6600aa, intensity: number = 0.5) {

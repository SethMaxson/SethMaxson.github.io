define("engine", ["require", "exports", "../../../../node_modules/three/src/Three.js", "../../../../node_modules/three/examples/jsm/effects/OutlineEffect.js", "../../../../sf/res/js/four.js", "../../../../sf/res/js/characters.js", "../../../../sf/res/js/PointerControls.js", "../../../../sf/res/js/dialog.js", "../../../../sf/res/js/sky.js"], function (require, exports, THREE, OutlineEffect_js_1, four_js_1, characters_js_1, PointerControls_js_1, dialog_js_1, sky_js_1) {
    "use strict";
    ...
    (function (Engine) {
        ...
        function Initialize(controlsType) {
            exports.main = new Engine.Main(controlsType);
            return exports.main;
        }
        ...
        */
        class Main {
            constructor(controlsType = "Human") {
                ...
                this.renderer = four_js_1.FOUR.Renderer();
                ...
                this.Sky = new sky_js_1.Sky(this);
                this.Scene.add(this.Sky);
                this._effect = new OutlineEffect_js_1.OutlineEffect(this.renderer, {
        ...
        */
        ...
        class Entity {
            constructor(model) {
                ...
                if (model == undefined) {
                    this._Model = new characters_js_1.Characters.Person3D();
                }
                else {
                    this._Model = model;
        ...
        */
        ...
        class Controls {
            constructor(camera, main) {
                ...
                this._zoomMin = 0.2;
                this.Camera = camera;
                this.PointerControls = new PointerControls_js_1.PointerLockControls(this.Camera, main.renderer.domElement);
                this.mainProcess = main;
        ...
        class PlayerControls extends Controls {
            constructor(camera, main) {
                ...
                this.height = 0.50;
                this.firstPerson = true;
                this.mesh = new characters_js_1.Characters.Person3D();
            ...
            getInteractions() {
                    ...
                    if (ent != undefined) {
                        ...
                        if (this.InputManager.keys.talk.down == true) {
                            ...
                            if (aimIntersections[0].distance <= 5) {
                                ...
                                speak(dialog_js_1.Dialog.getDialog(ent.Model.name), 0, function () {
                ...
                $("#debug").html(`
				<div>Location: ${thing.x}, Y: ${thing.y}, Z: ${thing.z}</div>
				<div>Current Draw call count: ${exports.main.renderer.info.render.calls}</div>
			`);
            }
            updateRaycasters() {
                // this.motion.getWorldDirection(new THREE.Vector3()).negate();
...
//# sourceMappingURL=engine-test-build.js.map